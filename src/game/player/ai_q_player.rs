...
const LR_DECAY:f64 = 500000f64; //NN learning rate decrease (half every DECAY games)
...
const RND_PICK_DEC:f64 = 500000f64; //random exploration decrease (half every DEC games)
